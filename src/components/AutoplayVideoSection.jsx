/**
 * AutoplayVideoSection — DESKTOP ONLY
 * Simple full-width autoplay video, no scroll locking.
 */
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(to bottom, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.0) 50%, rgba(0,0,0,0.2) 100%)',
        pointerEvents: 'none',
      }} />
    </section>
  );
